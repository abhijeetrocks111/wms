...
public class TestData {
	...
	public static final String userRole = "Tier 1";
	public static final String userTemplate = "Template 1";
	public static final String userStatus = "Active";
	public static final String userPhone = "1234567890";
	public static final String userShift = "Day";
